...
var PeriAllyDiscScene = preload("res://02_Source/02_Combat/Discs/SpecialDiscs/AllyDiscs/periwinkle_ally_disc.tscn")
...
var Disc8: AllyDisc = PeriAllyDiscScene.instantiate()
...
func _ready() -> void:
	...
	Disc8.position.x += 550
	Disc8.position.y += 210
	add_child(Disc8)
	pass
